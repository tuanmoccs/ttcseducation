        ...
        <div class="col-md-6 pe-5 mt-5 mt-md-0">
          ...
          <div>
            <form id="form" class="d-flex align-items-center position-relative ">
              <input type="text" name="document" placeholder="Tài liệu đang tìm kiếm"
        ...
        <div class="col-md-4">
          <div class="primary rounded-3 p-4 my-3" style="cursor: pointer;">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <a class="category-paragraph fw-bold text-uppercase mb-1">Phát triển ứng dụng Web</a>
                <p class="category-paragraph m-0">39 Documents </p>
              </div>
            </div>
          </div>
          <div class="tertiary rounded-3 p-4 my-3" style="cursor: pointer;">
            <div class="d-flex align-items-center">
              <div class="ps-4">
                <a class="category-paragraph fw-bold text-uppercase mb-1">Lập trình căn bản</a>
          ...
          <div class="secondary rounded-3 p-4 my-3" style="cursor: pointer;">
            <div class="d-flex align-items-center">
              <div class="ps-4">
                <a class="category-paragraph fw-bold text-uppercase mb-1">Lập trình hướng đối tượng</a>
        ...
        <div class="col-md-4">
          <div class="gray rounded-3 p-4 my-3" style="cursor: pointer;">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <a class="category-paragraph fw-bold text-uppercase mb-1">Otomat </a>
          ...
          <div class="secondary rounded-3 p-4 my-3" style="cursor: pointer;">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <a class="category-paragraph fw-bold text-uppercase mb-1">Chương trình dịch</a>
                <p class="category-paragraph m-0">16 courses</p>
              </div>
            </div>
          </div>
          <div class="tertiary rounded-3 p-4 my-3" style="cursor: pointer;">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <a class="category-paragraph fw-bold text-uppercase mb-1">Phát tiển phần mềm ứng dụng</a>
                <p class="category-paragraph m-0">24 courses</p>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="tertiary rounded-3 p-4 my-3" style="cursor: pointer;">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <a class="category-paragraph fw-bold text-uppercase mb-1">Lập trình ANDROID</a>
                <p class="category-paragraph m-0">24 courses</p>
              </div>
            </div>
          </div>
          <div class="primary rounded-3 p-4 my-3" style="cursor: pointer;">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <a class="category-paragraph fw-bold text-uppercase mb-1">Cấu trúc dữ liệu và giải thuật</a>
                <p class="category-paragraph m-0">39 courses</p>
              </div>
            </div>
          </div>
          <div class="gray rounded-3 p-4 my-3" style="cursor: pointer;">
            <div class="d-flex align-items-center">
              ...
              <div class="ps-4">
                <a class="category-paragraph fw-bold text-uppercase mb-1">Lý thuyết độ phức tạp tính toán</a>
                <p class="category-paragraph m-0">39 courses</p>
              </div>
            </div>
          </div>
